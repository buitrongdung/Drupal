<?php
namespace Drupal\field_datetime\Plugin\Field\FieldWidget;
 ...
 *     label = @Translation("Field DateTime widget"),
 *     field_types = {
 *          "field_datetime"
 *     }
 * )
 */
class FieldDateTimeWidget extends WidgetBase
{
