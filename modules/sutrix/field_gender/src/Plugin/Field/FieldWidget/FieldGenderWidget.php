<?php
namespace Drupal\field_gender\Plugin\Field\FieldWidget;
...
/**
 * @FieldWidget(
 *     id = "field_gender_widget",
 *     label = @Translation("Field Gender widget"),
 *     field_types = {
 *          "field_gender"
 *     }
 * )
 */
class FieldGenderWidget extends WidgetBase
{
